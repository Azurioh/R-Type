...
#define PAGINATION_IDX(value) value / PAGINATION_SIZE
#define IDX_IN_PAGINATION(value) value % PAGINATION_SIZE
...
namespace Engine {
    ...
    class ComponentPool {
        ...
        private:
            ...
            std::vector<std::vector<std::optional<std::size_t>>> _sparseArray;
